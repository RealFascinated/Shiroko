...
/**
 * A leaderboard that ranks guild ids. Carries the generic page and
 * position mechanics shared by every guild board; subclasses only
 * provide the four table-specific queries.
 */
export abstract class GuildLeaderboard<T extends LeaderboardRow> extends Leaderboard<T> {
  public override readonly entity: LeaderboardEntity = "guild";
  /** Global by default; a guild-scoped board overrides this. */
  public override readonly scope: LeaderboardScope = "global";
